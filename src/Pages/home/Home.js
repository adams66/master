		...
		<Container>
				<div style={{height: "100vh"}} className="row p-2 d-flex ">
					<div className="col-12 d-flex flex-column justify-content-center ">
						<h6 className="mb-4 intro_hi_color" style={{ fontWeight:"bolder",}}>Hi, my name is</h6>
						<h1 className="my_name_color" style={{fontWeight:"bolder"}}>Dalton Adams</h1>
						<h1 className="slogan_color" style={{fontWeight:"bolder"}}>I build things for the web.</h1>
						...
						<div>
						<a className='btn button_button_color button_border_color button_background_color p-custom fw-bold' href="#projects">Check out my projects</a>
						</div>
					</div>
				</div>
